...
function CostSummaryCards({ timeRange }: { timeRange: string }) {
  ...
  const changeIcon = summary.monthOverMonthChange > 0 ? ArrowUpRight : 
                    summary.monthOverMonthChange < 0 ? ArrowDownRight : Minus;
  const changeColor = summary.monthOverMonthChange > 0 ? "text-red-600" : 
                     summary.monthOverMonthChange < 0 ? "text-green-600" : "text-gray-600";
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-primary text-hive-blue">{summary.activeTherapistAccounts || 0}</p>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-hive-black/50">{summary.totalAppointments || 0} appointments</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-hive-black/50">
                {summary.budgetUtilization?.actualCost ? formatCurrency(summary.budgetUtilization.actualCost) : '£0.00'} / {summary.budgetUtilization?.budgetAmount ? formatCurrency(summary.budgetUtilization.budgetAmount) : '£0.00'}
              </p>
            </div>
            ...
            <tbody>
              {therapists.map((therapist: any) => (
                <tr key={therapist.therapistId} className="border-b hover:bg-gray-50/50">
                  <td className="p-3">
                    <div>
                      <p className="font-medium text-hive-black" data-testid={`text-therapist-name-${therapist.therapistId}`}>
                  ...
                  <td className="p-3 text-right font-medium" data-testid={`text-cost-${therapist.therapistId}`}>
                    £{therapist.totalMonthlyCost.toFixed(2)}
                  </td>
                  <td className="p-3 text-right" data-testid={`text-appointments-${therapist.therapistId}`}>
                    {therapist.appointmentsScheduled}
                  </td>
                  <td className="p-3 text-right">
                    £{therapist.costPerAppointment.toFixed(2)}
                  </td>
                  <td className="p-3 text-right">
                  ...
                  <td className="p-3 text-center">
                    <Badge 
                      ...
                      className={therapist.accountStatus === 'active' ? 'bg-green-100 text-green-800' : ''}
                    >
                  ...
                  <td className="p-3 text-center">
                    <Link href={`/admin/costs/therapist/${therapist.therapistId}`}>
                      <Button variant="ghost" size="sm" data-testid={`button-view-details-${therapist.therapistId}`}>
            ...
            <div key={index} className="border rounded-lg p-4 hover:bg-gray-50/50">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <h4 className="font-medium text-hive-black mb-1" data-testid={`text-recommendation-title-${index}`}>
                    {rec.title}
                  </h4>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-hive-purple mb-2" data-testid="text-dashboard-title">
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid w-full grid-cols-4">
            ...
            <TabsTrigger value="therapists" data-testid="tab-therapists">Therapists</TabsTrigger>
