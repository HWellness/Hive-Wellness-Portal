        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-2">Sessions completed successfully</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-2">Average client rating</p>
            </div>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          {data.popularTherapyTypes.length === 0 ? (
            ...
            <div className="space-y-4">
              {data.popularTherapyTypes.map(
                (therapy: { type: string; count: number }, index: number) => (
          ...
          {data.monthlyStats.length === 0 ? (
            ...
            <div className="space-y-4">
              {data.monthlyStats.map(
                (stat: { month: string; sessions: number; revenue: number }) => (
