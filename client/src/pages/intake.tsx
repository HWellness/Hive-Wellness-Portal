...
import { Brain, Heart, Users, GraduationCap, Puzzle, Mail, HandHeart, ArrowLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-hive-neutral to-white py-12 relative">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="mb-8">
          <Link href="/portal">
            <Button variant="ghost" className="text-hive-purple hover:text-hive-purple hover:bg-hive-purple/10 font-secondary">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-hive-black max-w-2xl mx-auto font-secondary">
            Experience our intelligent form system with automated workflow triggers and AI-powered processing.
            Select a form below to see the unified system in action.
          </p>
        </div>
              ...
              >
                ...
                <CardContent>
                  <div className="bg-white rounded-lg p-4 mb-4">
                    <h4 className="font-semibold text-hive-purple mb-2 font-primary">Automated Workflow:</h4>
                    <p className="text-sm text-hive-black font-secondary">{option.triggerDescription}</p>
                  </div>
                  
                  <div className="bg-white rounded-lg p-4">
                    <h4 className="font-semibold text-hive-purple mb-2 font-primary">Form Features:</h4>
