                ...
                <CardContent className="p-8">
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-purple-50 to-hive-light-purple/30 rounded-xl border border-hive-purple/20">
                    <div className="text-center mb-4">
                      <h4 className="font-primary font-semibold text-gray-800 text-sm mb-1">Free Introduction Call</h4>
                      <p className="text-xs font-secondary text-gray-600">No account needed - book your call now</p>
                    </div>
                    <Button 
                  ...
                  <div className="mb-6 p-4 bg-gradient-to-r from-hive-light-purple/20 to-hive-background/30 rounded-xl border border-hive-purple/20">
                    <div className="text-center mb-4">
                      <h4 className="font-primary font-semibold text-hive-black text-sm mb-1">Login</h4>
                      <p className="text-xs font-secondary text-hive-black/70">For clients and institutions</p>
                    </div>
                    <Link to="/login">
                      <Button 
                        className="w-full bg-hive-purple hover:bg-hive-purple/90 text-white font-medium transition-all duration-200"
      ...
      {videoLink && (
        <Dialog open={!!videoLink} onOpenChange={() => setVideoLink(null)}>
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle className="text-xl font-primary text-center" style={{ color: '#9306B1' }}>
            ...
            <div className="space-y-4 text-center">
              <div className="border rounded-lg p-4" style={{ backgroundColor: 'rgba(147, 6, 177, 0.05)', borderColor: 'rgba(147, 6, 177, 0.2)' }}>
                <div className="flex items-center justify-center mb-3">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(147, 6, 177, 0.1)' }}>
                    <span className="text-2xl">📧</span>
                  </div>
                </div>
                <h3 className="font-semibold mb-2" style={{ color: '#9306B1' }}>Check Your Email</h3>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <p className="text-blue-700 text-sm">
                  <strong>Next Steps:</strong> Click "Add to Calendar" in your email and join the meeting 
                  from your calendar at the scheduled time.
                </p>
              </div>
