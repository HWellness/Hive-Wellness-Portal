        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Thank you for your interest in Hive Wellness. Our team will review your request and contact you within 24 hours to confirm your appointment.
            </p>
            <div className="bg-purple-50 p-4 rounded-lg">
              <p className="text-sm text-purple-700">
                <strong>Next Steps:</strong><br />
                • We'll call or email you to confirm the appointment<br />
                • The initial consultation is completely free<br />
      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`px-3 py-1 rounded-full text-sm font-medium ${
                  ...
                  {formData.userType === 'therapist' ? '👩‍⚕️ Therapist Application' : '👤 Client Enquiry'}
                </div>
              </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6 text-gray-900">
                ...
                <div className="space-y-2">
                  {isLoadingAvailability ? (
                    <div className="flex items-center justify-center p-4">
                      ...
                      <span className="ml-2 text-sm text-gray-800 font-medium">Loading availability...</span>
                    </div>
                  ) : (
                      ...
                      {timeSlots.map((time) => {
                        ...
                        return (
                          <Button
                            ...
                            title={!isAvailable ? `Unavailable: ${slotInfo?.conflictReason || 'Slot booked'}` : `Available at ${time}`}
                          >
            ...
            <div className="space-y-3">
              <Label htmlFor="message" className="text-gray-900 font-medium">How Can We Help?</Label>
              <Textarea
                id="message"
          ...
          <div className="bg-gray-50 px-6 py-4 text-center">
            <p className="text-sm text-gray-600">
              Questions? Contact us at <a href="mailto:support@hive-wellness.co.uk" className="text-purple-600 hover:underline">support@hive-wellness.co.uk</a>
            </p>
          </div>
        </div>
      </div>
