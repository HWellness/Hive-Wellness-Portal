...
export default function BookAdminCallTherapist() {
  ...
  const loadAvailability = async (date: Date) => {
    ...
    try {
      const response = await fetch(`/api/calendar/public-availability?date=${format(date, 'dd-MM-yyyy')}`);
      if (response.ok) {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center">
        <div className="animate-spin rounded-full h-12 w-12 border-b-2" style={{ borderBottomColor: '#9306B1' }}></div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <div className="border rounded-lg p-4 mb-6" style={{ backgroundColor: '#F3F4F6', borderColor: '#E5E7EB' }}>
            <h3 className="font-semibold mb-2" style={{ color: '#9306B1' }}>Next Steps:</h3>
      ...
      <div className="max-w-lg w-full bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6 bg-purple-50 border-b">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium" style={{ color: '#9306B1' }}>Therapist Application</span>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* What to Expect */}
          <div className="border rounded-lg p-4" style={{ backgroundColor: '#F9F5FF', borderColor: '#E0E7FF' }}>
