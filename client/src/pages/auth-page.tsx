          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="bg-white p-2 rounded border">
                  <strong>Therapist Demo:</strong><br />
                  therapist@demo.hive<br />
                  <span className="text-gray-500">No password needed</span>
                </div>
              </div>
          ...
          <div className="hidden lg:flex flex-col justify-center space-y-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-lg leading-relaxed">
                Connect with qualified therapists, manage appointments, and track your mental health journey 
                with our comprehensive therapy management system.
              </p>
            </div>
