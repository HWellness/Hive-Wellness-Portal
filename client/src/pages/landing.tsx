    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-3xl font-body text-hive-dark mb-4 font-semibold">Therapy Tailored to You</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="card-modern p-10 group hover:scale-[1.02] transition-all duration-300">
            <div className="text-center mb-8">
              ...
              <p className="text-hive-gray font-body text-lg leading-relaxed">
                Finding the right therapist shouldn't be overwhelming. We connect you with the perfect 
                therapist for your unique journey—seamlessly and stress-free.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <Link to="/portal">
                <button className="w-full py-3 px-6 bg-white text-hive-purple border-2 border-hive-purple rounded-lg font-semibold hover:bg-hive-purple/5 transition-colors" data-testid="button-get-started">
                  Get Started
                </button>
              </Link>
            </div>
          ...
          <div className="card-modern p-10 group hover:scale-[1.02] transition-all duration-300">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-display font-bold text-hive-dark mb-4">For Therapists</h3>
              <p className="text-hive-gray font-body text-lg leading-relaxed">
                A professional platform designed to support your practice and growth. Focus on what you do best—
        ...
        <div className="mt-16 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-hive-gray">Real people, not algorithms, helping you find the right therapist</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-hive-purple rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-hive-gray">GDPR & UK Data Protection Act compliant platform with enterprise-grade security</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-hive-purple rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-hive-gray">Everything you need in one platform - scheduling, payments, sessions</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 max-w-6xl mx-auto mb-16">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Create your secure account in under 2 minutes. We only ask for basic information to get started.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Complete a brief questionnaire about your therapy goals and preferences. Takes 10-15 minutes.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Our team reviews your responses and presents 3-5 carefully selected therapist connections.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Book your free 20-minute consultation, then schedule your first session whenever you're ready.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 p-4 bg-white rounded-lg border-l-4 border-hive-purple">
              <p className="text-gray-700 italic">
                <strong>Privacy Note:</strong> All information is kept strictly confidential and is only used to match you with the most suitable therapist. You can update or delete your information at any time.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-r from-hive-purple/10 to-purple-100/50 rounded-3xl p-8 max-w-4xl mx-auto border border-hive-purple/20">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 text-lg max-w-2xl mx-auto">
                Ready to make a meaningful impact? We're looking for qualified therapists who share our commitment to personalised, human-centred care.
              </p>
            </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-hive-white rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              We're here when you're ready. It's completely normal to feel unsure - 
              that's exactly why we're here to help. The whole process takes about 20 minutes.
            </p>
            <Link to="/portal">
