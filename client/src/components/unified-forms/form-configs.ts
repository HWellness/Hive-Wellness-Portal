...
export const therapyMatchingConfig: FormConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: "Location",
      subtitle:
        "This helps us match you with therapists in your area or available for online sessions.",
      type: "text",
      validation: { required: true },
    },
    {
...
export const therapistOnboardingConfig: FormConfig = {
  ...
  steps: [
    ...
    },
    {
      ...
      subtitle:
        "Please provide a brief professional biography that clients will see (minimum 100 words)",
      type: "textarea",
