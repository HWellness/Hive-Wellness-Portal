  ...
  const renderStepContent = () => {
    ...
    switch (step.type) {
      case "single-select":
        return (
          <div className="space-y-3">
            ...
            {error && (
              <div className="text-hive-error bg-hive-error/10 border border-hive-error/20 p-3 rounded-lg text-sm">
                {error}
              </div>
            )}
          </div>
        ...
        return (
          <div className="space-y-4">
            <div className="flex justify-center items-center space-x-2 bg-purple-50 p-4 rounded-lg">
              <span className="text-sm text-hive-purple font-secondary">
      ...
      default:
        ...
        return (
          <div className="space-y-4">
            <p className="text-hive-black font-secondary">Please select an option to continue.</p>
            {error && (
              <div className="text-hive-error bg-hive-error/10 border border-hive-error/20 p-3 rounded-lg text-sm">
                {error}
              </div>
      ...
      <div className="hive-form-card relative">
        ...
        <div className="hive-form-header">
          ...
          <div className="hive-progress-bar">
            <div className="hive-progress-fill" style={{ width: `${progress}%` }} />
          </div>
        </div>
