        ...
        screenShareRef.current.onloadedmetadata = () => {
          ...
          if (screenShareRef.current) {
            screenShareRef.current.play().catch(e => 
              console.log('Screen share auto-play prevented:', e)
            );
          }
        };
      }
        ...
        if (localVideoRef.current && localStreamRef.current) {
          ...
          setTimeout(() => {
            if (localVideoRef.current && localStreamRef.current) {
              localVideoRef.current.srcObject = localStreamRef.current;
              localVideoRef.current.play().catch(e => 
                console.log('Camera refresh auto-play prevented:', e)
              );
            }
          }, 100);
        }
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-blue-700 space-y-1">
                    <li>• If your camera feed appears frozen or black, click the refresh button (🔄) in the controls</li>
                    <li>• Use the camera/microphone buttons to test your video and audio before the session</li>
                    <li>• For screen sharing, click the monitor button and select your screen or application</li>
