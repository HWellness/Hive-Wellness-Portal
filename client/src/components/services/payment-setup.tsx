...
import { CreditCard, CheckCircle, AlertTriangle, ExternalLink, PoundSterling, TrendingUp, Settings } from 'lucide-react';
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <div className="text-hive-purple font-century text-lg font-bold">Loading Payment Setup</div>
        </div>
      </div>
    );
  }
          ...
          <Card className="border-red-200 bg-red-50">
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <p className="text-red-600">Unable to load payment status. Please try again later.</p>
              </div>
            </CardContent>
          </Card>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white p-6">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-hive-black/70 font-secondary">Configure your payment processing with Hive Wellness</p>
        </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="font-medium text-hive-black">
                    {paymentStatus?.status === 'active' ? 'Payment Setup Complete' : 
                     paymentStatus?.status === 'pending' ? 'Setup In Progress' :
                     'Setup Required'}
                  </p>
                  <p className="text-sm text-hive-black/70">
                    {paymentStatus?.status === 'active' ? 'Ready to receive payments with 85% revenue share (payout schedule set by Stripe based on your account risk profile)' :
                     paymentStatus?.status === 'pending' ? 'Please complete any pending setup steps' :
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-r from-hive-purple/5 to-hive-blue/5">
          ...
          <CardContent>
            ...
            <div className="mt-4 p-3 bg-white/50 rounded border border-hive-purple/20">
              <p className="text-sm text-hive-black/70">
                • Instant payouts available • Stripe processing fees covered by platform
                • Weekly automated payouts • Full transaction transparency
            ...
            <CardContent className="space-y-6">
              ...
              <div className="p-6 border border-hive-purple/20 rounded-lg bg-hive-purple/5">
                ...
                <p className="text-sm text-hive-black/70 mb-4">
                  <strong>Connect with Stripe</strong> to securely handle payments. You'll be taken to Stripe's secure portal to provide your banking details and verify your account. This typically takes 2-3 minutes.
                </p>
                <Button 
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                      ...
                      <li>• Business details (Industry: Mental Health Services, Website: www.hive-wellness.co.uk)</li>
                      <li>• Your address and contact information</li>
                    </ul>
                    <p className="text-sm text-blue-700 mt-3">
                      Please note: Most accounts are approved instantly. The secure Stripe verification portal will open in a new tab.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Button 
                  onClick={() => {
                    ...
                    if (paymentStatus?.dashboardUrl) {
                      ...
                      toast({
                        title: "Demo Account",
                        description: "This is a demo account. In production, this would open the Stripe Connect dashboard.",
                      });
                    } else {
                      toast({
                        title: "Setup Required",
                        description: "Please complete payment setup first to access your dashboard.",
                        variant: "destructive",
                      });
                    }
                  }}
