...
import { Send, User, Paperclip, Smile, MoreHorizontal, Search, Filter, Archive, MessageCircle } from "lucide-react";
...
export default function Messaging({ user, onBackToDashboard }: MessagingProps) {
  ...
  const handleAttachmentClick = () => {
    toast({
      ...
      description: "File attachment functionality will be available in a future update for secure document sharing.",
    });
  };
      ...
      <div className="absolute top-0 left-0 right-0 z-10 bg-white border-b border-gray-200 p-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 font-secondary">Secure communication with your therapy team</p>
          </div>
              ...
              {canStartConversations ? (
                ...
                <div className="p-4 space-y-4">
                  <div className="text-center mb-4">
                    <h3 className="font-semibold text-gray-900 mb-2">Start a conversation with your therapist</h3>
                    <p className="text-sm text-gray-600">Begin your secure messaging with your assigned therapy team.</p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      Your Message
      ...
      <div className="flex w-full mt-24">
        ...
        <div className="w-1/3 border-r border-gray-200 flex flex-col">
          ...
          <div className="p-6 border-b border-gray-200">
            <h2 className="text-lg font-primary font-semibold text-gray-900 mb-4">Conversations</h2>
        ...
        <div className="flex-1 overflow-y-auto">
          {conversationsLoading ? (
            ...
            <div className="text-center py-12 px-6">
              ...
              <h3 className="font-primary font-semibold text-gray-900 mb-2">No conversations yet</h3>
              <p className="text-gray-600 text-sm font-secondary">Your therapist will message you here, or you can start a conversation.</p>
            </div>
          ) : (
            <div className="p-2">
            ...
            <div className="bg-hive-background/30 border-b border-hive-blue/20 p-4">
              <div className="flex items-center gap-2">
                <div className="flex-shrink-0">
                  <svg className="w-5 h-5 text-hive-purple" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                </div>
                <div className="flex-1">
                  <p className="text-sm font-medium text-hive-black/70">
                    Privacy Notice: Please do not include personal information in messages. All communications are monitored by Hive Wellness staff for quality assurance and security purposes.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 border-t border-gray-200">
              <div className="mb-3 px-3 py-2 bg-hive-purple/10 border border-hive-purple/30 rounded-lg">
                <p className="text-xs text-hive-purple">
                  <strong>Reminder:</strong> Please do not share personal information such as full names, addresses, phone numbers, or identifying details in messages.
                </p>
              </div>
            ...
            <div className="max-w-2xl w-full">
              <div className="text-center mb-8">
                ...
                <h3 className="text-xl font-display font-semibold text-gray-900 mb-2">
                  {user.role === 'therapist' || user.role === 'admin' ? 'Secure Messaging for Your Practice' : 'Select a conversation'}
                </h3>
                ...
                <Card className="card-modern">
                  ...
                  <CardContent className="space-y-4">
                    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg p-4 border border-purple-100">
                      <h4 className="font-semibold text-gray-900 mb-2 text-sm">📅 Session Rescheduling</h4>
                      <p className="text-sm text-gray-700 italic leading-relaxed">
                        "Hi John, I am sorry but I need to rearrange our session. Can you do 5pm tomorrow instead? If so, please just book in for the new time through the portal."
                      </p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 border border-blue-100">
                      <h4 className="font-semibold text-gray-900 mb-2 text-sm">✨ Session Follow-up</h4>
                      <p className="text-sm text-gray-700 italic leading-relaxed">
                        "Hi Sarah, thank you for our session today. Remember to practice the breathing techniques we discussed. How are you feeling about implementing them?"
                      </p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-lg p-4 border border-green-100">
                      <h4 className="font-semibold text-gray-900 mb-2 text-sm">🔔 Appointment Reminder</h4>
                      <p className="text-sm text-gray-700 italic leading-relaxed">
                        "Hi Emma, looking forward to seeing you tomorrow at 3pm. Please let me know if you need to reschedule or have any questions before we meet."
                      </p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-lg p-4 border border-amber-100">
                      <h4 className="font-semibold text-gray-900 mb-2 text-sm">📝 Resource Sharing</h4>
                      <p className="text-sm text-gray-700 italic leading-relaxed">
                        "Hi Michael, I wanted to share some resources about cognitive behavioural techniques. I'll upload the materials to your portal - they might be helpful before our next session."
                      </p>
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-hive-purple/5 border border-hive-purple/20 rounded-lg">
                      <p className="text-xs text-gray-600 flex items-start gap-2">
                        ...
                        <span><strong>Privacy Note:</strong> Remember not to include sensitive clinical details or personal information in messages. All conversations are monitored for quality assurance and security.</span>
                      </p>
                    </div>
                  </CardContent>
                </Card>
