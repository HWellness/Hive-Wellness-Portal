...
export default function ClientProgress({ user }: ClientProgressProps) {
  ...
  const submitWellnessMetricsMutation = useMutation({
    mutationFn: async (data: { moodScore: number; sleepQuality: number; stressLevel: number; notes?: string }) => {
  ...
  const chartData = wellnessMetrics.slice(0, 14).reverse().map((metric) => ({
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div className="text-white">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold font-century">Your Progress Overview</h1>
              </div>
              <p className="text-purple-100 text-lg leading-relaxed max-w-2xl">
                Track your wellness journey and session progress with detailed insights and personalised metrics
              </p>
            </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{progressMetrics.overallProgress}%</p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{progressMetrics.sessionAttendance}%</p>
                </div>
                <div className="h-14 w-14 bg-gradient-to-br from-hive-purple to-hive-purple/80 rounded-xl flex items-center justify-center shadow-lg">
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-3xl font-bold text-hive-purple">+{progressMetrics.weeklyImprovement}%</p>
                </div>
                <div className="h-14 w-14 bg-gradient-to-br from-hive-purple to-hive-purple/80 rounded-xl flex items-center justify-center shadow-lg">
                  <TrendingUp className="h-7 w-7 text-white" />
                </div>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="group text-center p-6 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-3xl font-bold text-gray-900 mb-2">{progressMetrics.moodScore}/10</p>
                ...
                <div className="group text-center p-6 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-3xl font-bold text-gray-900 mb-2">{progressMetrics.stressLevel}/10</p>
                  <div className="w-full bg-purple-200 rounded-full h-2 mb-2">
                    <div 
                      className="bg-gradient-to-r from-hive-purple to-purple-600 h-2 rounded-full transition-all duration-500" 
                ...
                <div className="group text-center p-6 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-3xl font-bold text-gray-900 mb-2">{progressMetrics.sleepQuality}/10</p>
                  <div className="w-full bg-purple-200 rounded-full h-2 mb-2">
                    <div 
                      className="bg-gradient-to-r from-hive-purple to-purple-600 h-2 rounded-full transition-all duration-500" 
              ...
              <CardContent className="space-y-6">
                <div className="space-y-3">
                  ...
                  <Slider
                    ...
                    className="w-full"
                  />
                  <p className="text-xs text-gray-500">How would you rate your overall mood today?</p>
                </div>
              ...
              <CardContent>
                {isLoadingMetrics ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-64 text-center">
                    ...
                    <p className="text-sm text-gray-400 mt-1">Start tracking your daily wellness to see trends</p>
                  </div>
                ) : (
                      ...
                      <div className="flex items-center gap-1">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            className={`h-4 w-4 ${
                              i < session.rating ? 'text-purple-400 fill-current' : 'text-gray-300'
                            }`}
                          />
                        ))}
                      </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-800 text-sm mt-1">
                        You've shown consistent improvement in anxiety management over the past month. 
                        Your coping strategies are working well.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-800 text-sm mt-1">
                        You've maintained an 85% attendance rate, which is excellent for therapy outcomes. 
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-purple-800 text-sm mt-1">
                        Consider discussing sleep hygiene in your next session. Better sleep quality 
                        could enhance your overall progress.
                      </p>
                    </div>
                  </div>
                </div>
