...
import { Users, UserPlus, Search, Shield, Ban, RotateCcw, Mail, Phone, Calendar, Edit, Trash2, Eye, UserCheck, AlertTriangle } from "lucide-react";
...
export default function AdminUserManagement({ user }: AdminUserManagementProps) {
  ...
  const getRoleIcon = (role: string) => {
    switch (role) {
      ...
      case 'therapist': return <UserCheck className="h-4 w-4" />;
      case 'admin': return <Shield className="h-4 w-4" />;
      case 'institution': return <Users className="h-4 w-4" />;
          ...
          <div className="space-y-4">
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <p className="text-yellow-700 mt-1">
                This will immediately revoke access for <strong>{selectedUser?.firstName} {selectedUser?.lastName}</strong> and terminate any active sessions.
              </p>
            </div>
            ...
            <div>
              ...
              <Select value={suspendData.duration} onValueChange={(value) => setSuspendData(prev => ({ ...prev, duration: value }))}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
