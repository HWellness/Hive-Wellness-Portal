              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Use variables like: client_name, therapist_name, appointment_date,
                    appointment_time, session_amount
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setCampaignData((prev) => ({ ...prev, recipientType: value }))
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      setCampaignData((prev) => ({ ...prev, content: e.target.value }))
                    }
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <div className="flex items-center space-x-4 text-xs text-gray-500 mt-1">
                          ...
                          {template.lastUsed && (
                            <span>
                              Last used: {new Date(template.lastUsed).toLocaleDateString("en-GB")}
                            </span>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-500">
                        ...
                        {campaign.scheduledDate && campaign.status === "scheduled" && (
                          <span>
                            Scheduled for:{" "}
                            {new Date(campaign.scheduledDate).toLocaleDateString("en-GB")}
                          </span>
                        )}
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-xs text-gray-500">
                        ...
                        {email.scheduledFor && (
                          <span>
                            Scheduled: {new Date(email.scheduledFor).toLocaleDateString("en-GB")}
                          </span>
                        )}
                        {email.sentAt && (
