...
export default function TherapistEarningsManagement({ user }: TherapistEarningsManagementProps) {
  ...
  const setupStripeConnectMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      if (data.onboardingUrl) {
        ...
        const popup = window.open(data.onboardingUrl, '_blank', 'width=800,height=600,scrollbars=yes,resizable=yes');
        ...
        if (!popup || popup.closed || typeof popup.closed == 'undefined') {
          ...
          toast({
            title: "Stripe Connect Setup",
            description: "Complete your bank account setup in the new window to start receiving payments.",
          });
        }
      } else {
        toast({
  ...
  const demoEarnings: EarningsData = {
    ...
    thisMonthEarnings: 4680.00,
    thisWeekEarnings: 1275.00,
    todayEarnings: 255.00,
  ...
  const demoEarningsBreakdown: EarningsBreakdown = {
    sessionEarnings: 4560.00,
    consultationEarnings: 360.00,
    netEarnings: 4182.00  // 85% of total (4920)
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Badge className="bg-hive-light-blue text-hive-purple">
          {displayEarnings.stripeConnectStatus === 'active' ? 'Payment Setup Complete' : 'Setup Required'}
        </Badge>
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-hive-black">
                You receive <strong>exactly 85% of every session fee</strong>. All payment processing is handled seamlessly by Hive Wellness.
              </p>
              <div className="bg-white/60 rounded-lg p-3 mt-3">
                <h4 className="font-medium text-hive-purple text-sm">Payout Options</h4>
                <p className="text-xs text-hive-black">• Standard payouts: Free (1-3 business days)</p>
                <p className="text-xs text-hive-black">• Instant payouts: 1% fee for immediate transfer</p>
                <p className="text-xs text-hive-black mt-2"><strong>Note:</strong> Payout timing depends on your Stripe account standing. Manage earnings in your Stripe Connect dashboard.</p>
              </div>
            </div>
          </div>
        </CardContent>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-hive-black mt-1">{displayEarnings.sessionsThisMonth} sessions</p>
              </div>
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Minimum: £{displayEarnings.minimumPayoutAmount} | Maximum: £{displayEarnings.availableForPayout}
                      </p>
                      ...
                      <div className="flex gap-2 flex-wrap mt-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          onClick={() => setPayoutAmount(displayEarnings.availableForPayout.toString())}
                          className="text-xs"
                        >
                          All Available
                        </Button>
                    ...
                    <div>
                      ...
                      <Select value={payoutMethod} onValueChange={(value: 'instant' | 'standard') => setPayoutMethod(value)}>
                        <SelectTrigger>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="standard">
                            <div className="flex flex-col">
                              ...
                              <span className="text-xs text-gray-500">Variable schedule (set by Stripe based on account risk profile) • No fee</span>
                            </div>
                          </SelectItem>
                        </SelectContent>
                      </Select>
                        ...
                        <div className="space-y-1 text-sm">
                          ...
                          {payoutMethod === 'instant' && (
                            <div className="flex justify-between">
                              ...
                              <span>-£{calculateInstantPayoutFee(parseFloat(payoutAmount || '0')).toFixed(2)}</span>
                            </div>
                          )}
                          <div className="flex justify-between font-medium border-t pt-1">
                            <span>You'll receive:</span>
                            <span>
                              £{(parseFloat(payoutAmount || '0') - (payoutMethod === 'instant' ? calculateInstantPayoutFee(parseFloat(payoutAmount || '0')) : 0)).toFixed(2)}
                            </span>
                          </div>
                          <div className="text-xs text-blue-700 mt-2 bg-blue-100 p-2 rounded">
                            <strong>Note:</strong> This amount is already after Stripe processing fees were deducted from original payments. 
                            <a href="https://stripe.com/gb/pricing" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-800">
                              View Stripe fees
                            </a>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      {requestPayoutMutation.isPending ? 'Processing...' : `Request ${payoutMethod === 'instant' ? 'Instant' : 'Standard'} Payout`}
                    </Button>
                  </>
                )}
              </CardContent>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded p-3">
                    <h5 className="text-xs font-semibold text-blue-800 mb-1">Payout Schedule Options</h5>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-gray-600">
                          {payout.method === 'stripe_instant' ? 'Instant Payout' : 'Standard Payout'}
                        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-4">
                  ...
                  <div className="text-sm text-blue-700 space-y-2">
                    <p>
                      You receive <strong>exactly 85% of every session fee</strong>. All payment processing is managed by Hive Wellness.
                    </p>
                    <div className="bg-blue-100 p-2 rounded mt-3">
                      <div className="text-xs space-y-1">
                        <p><strong>Standard Payouts:</strong> Free (1-3 business days)</p>
                        <p><strong>Instant Payouts:</strong> 1% fee for immediate transfer</p>
                      </div>
                    </div>
                    <div className="bg-white border border-blue-300 p-3 rounded mt-3">
                      <p className="text-xs text-blue-900 font-semibold mb-2">Important: Stripe Connect Account</p>
                      <div className="text-xs text-blue-800 space-y-1">
                        <p>• Every therapist must register with Stripe Connect to receive payments</p>
                        <p>• Your standing with Stripe determines the frequency of your payouts</p>
                        <p>• Your <strong>Stripe Connect dashboard</strong> is the most accurate place to manage your Hive Wellness earnings</p>
                        <p>• <strong>All payout queries</strong> should be directed to Stripe directly</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <Badge className={displayEarnings.stripeConnectStatus === 'active' ? 'bg-green-100 text-green-800' : 'bg-orange-100 text-orange-800'}>
                      {displayEarnings.stripeConnectStatus}
                    </Badge>
                  </div>
                  <div className="flex justify-between">
                    <span>Bank Account:</span>
                    <Badge className={displayEarnings.bankAccountConnected ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}>
