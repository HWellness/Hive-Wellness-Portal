...
const ClientTherapistAssignment = lazy(() => import("../admin/client-therapist-assignment").then(module => ({ default: module.ClientTherapistAssignment })));
const AssignmentNotifications = lazy(() => import("../admin/assignment-notifications").then(module => ({ default: module.AssignmentNotifications })));
...
const TherapistNotesUpload = lazy(() => import("./therapist-notes-upload").then(module => ({ default: module.TherapistNotesUpload })));
...
const TherapistApplicationsDashboard = lazy(() => import("../admin/therapist-applications-dashboard"));
const ClientQuestionnairesDashboard = lazy(() => import("../admin/client-questionnaires-dashboard"));
...
export default function ServiceRouter({ user, selectedService, onBack, onNavigateToService }: ServiceRouterProps) {
  const renderService = () => {
    switch (selectedService) {
      ...
      case 'client-management':
        return <ClientManagementComprehensive user={user} onNavigateToService={onNavigateToService} />;
      ...
      case 'real-data-import':
        const RealDataImportManager = lazy(() => import('../admin/real-data-import-manager').then(module => ({ default: module.RealDataImportManager })));
      ...
      default:
        return (
          <div className="text-center py-12">
            <h2 className="text-2xl font-display font-bold text-gray-900 mb-4">Service Not Found</h2>
