      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(147, 6, 177, 0.1)' }}>
              <span className="text-3xl" style={{ color: '#9306B1' }}>🎉</span>
            </div>
          </div>
        ...
        <div className="text-center space-y-4">
          ...
          <div className="text-xs text-hive-black/60 bg-blue-50 p-3 rounded-lg">
            <p>
              💡 <strong>Tip:</strong> Click the video call button at your appointment time. 
              The meeting will open in Google Meet - no account required!
            </p>
          </div>
