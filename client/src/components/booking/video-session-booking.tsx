...
export function VideoSessionBooking() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.therapistId || !formData.sessionDate || !formData.sessionTime || 
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {formData.sessionDate && formData.therapistId && (
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, sessionTime: value }))}
                >
                  <SelectTrigger>
            ...
            <Button 
              ...
              disabled={isBooking || !formData.therapistId || !formData.sessionDate || !formData.sessionTime}
            >
              {isBooking ? (
                <>
