  ...
  const bookingMutation = useMutation({
    mutationFn: async (bookingData: BookingFormData) => {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || errorData.message || `Failed to book: ${response.status}`);
      }
    ...
    onSuccess: (result) => {
      toast({
        ...
        description: "Your free introduction call has been scheduled. You'll receive a confirmation email shortly.",
      });
      ...
      <Card className="max-w-2xl mx-auto">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            ...
            <strong>{format(selectedDate!, 'EEEE, MMMM do')} at {selectedTime}</strong>
          </p>
          <div className="bg-purple-50 p-4 rounded-lg mb-6">
            ...
            <div className="text-sm text-purple-800 space-y-2 text-left">
              ...
              <p>A member of our team will join you on the call to get to know you and to get a better understanding of how we may best support you.</p>
              <p>We'll match you with the perfect therapist for your needs.</p>
              <p>Once you are matched with a Therapist, you will be able to book sessions with them. Your Therapist may also choose to message you to help further.</p>
            </div>
          </div>
          <Button onClick={() => window.location.href = '/'} className="bg-hive-purple hover:bg-hive-purple/90">
            Return to Homepage
          </Button>
        </CardContent>
      </Card>
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Schedule a 30-minute consultation with our team to discuss how we can support your wellness journey.
        </p>
                  ...
                  {selectedDate && selectedTime && (
                    <div className="mt-4 p-3 bg-purple-50 rounded-lg">
                      <p className="text-sm text-purple-800">
                        <strong>Selected:</strong> {format(selectedDate, 'EEEE, MMMM do')} at {selectedTime}
                      </p>
                    </div>
                  )}
                </div>
