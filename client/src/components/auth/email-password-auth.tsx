...
const EmailPasswordAuth: React.FC<EmailPasswordAuthProps> = ({ 
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: (userData) => {
      ...
      setTimeout(() => {
        const dashboardUrl = userData.user?.role === 'admin' ? '/admin-dashboard' : 
                            userData.user?.role === 'client' ? '/client-dashboard' :
                            userData.user?.role === 'therapist' ? '/' :
                            userData.user?.role === 'institution' ? '/institution-dashboard' : '/';
