    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage therapist applications and create accounts</p>
        </div>
        <Button onClick={() => refetch()} className="bg-hive-purple hover:bg-hive-purple/90">
                          ...
                          <td className="py-3 px-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium">
                                {application.applicationData?.first_name &&
                                application.applicationData?.last_name
