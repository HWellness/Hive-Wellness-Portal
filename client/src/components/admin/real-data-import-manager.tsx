...
import { Download, CheckCircle, AlertTriangle, Database, RefreshCw } from "lucide-react";
...
export function RealDataImportManager() {
  ...
  const [webhookStatus, setWebhookStatus] = useState<"active" | "inactive" | "checking">(
    "checking"
  );
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage imports of 100% accurate form responses from HubSpot for precise client-therapist
            matching
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Alert className="mb-4">
            ...
            <AlertDescription>
              <strong>Critical for Accuracy:</strong> This system ensures all client questionnaires
              and therapist applications are imported with real data for accurate matching and
            ...
            <TabsContent value="hubspot" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fetch all real form submissions from HubSpot API for client questionnaires and
                  ...
                  <div className="space-y-4">
                    ...
                    {process.env.HUBSPOT_API_KEY ? (
                      ...
                      <Alert variant="destructive">
                        <AlertTriangle className="h-4 w-4" />
                        <AlertDescription>
                          HubSpot API key required for real data import. Please configure in
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <Alert>
                      <AlertDescription>
                        The webhook automatically processes all form submissions from HubSpot and
                        WordPress Gravity Forms in real-time.
                      </AlertDescription>
                    </Alert>
                  </div>
                </CardContent>
