...
export default function TherapistApplicationReview({ className }: TherapistApplicationReviewProps) {
  ...
  const handleApprove = (application: TherapistApplication) => {
    updateStatusMutation.mutate({
      ...
      adminNotes:
        reviewNotes ||
        `Application approved. Therapist credentials verified and meets Hive Wellness standards.`,
    });
  };
  ...
  const pendingApplications = displayApplications.filter(
    (app: TherapistApplication) => app.status === "pending"
  );
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Dialog
                    open={showDetailDialog && selectedApplication?.id === application.id}
                              ...
                              <CardContent className="space-y-3">
                                ...
                                <div>
                                  ...
                                  <p className="flex items-center gap-2">
                                    ...
                                    {selectedApplication.streetAddress},{" "}
                            ...
                            <Card className="md:col-span-2">
                              ...
                              <CardContent>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                  {Object.entries(selectedApplication.availability).map(
                                    ([day, hours]) => (
