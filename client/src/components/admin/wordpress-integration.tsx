...
export default function WordPressIntegration({
  ...
  const {
    ...
    isLoading,
    error,
  } = useQuery<WordPressIntegrationStatus>({
            ...
            <div className="flex items-center justify-between pt-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  onClick={handleSync}
                  disabled={
                    !(status?.siteUrl && status?.publicApiKey && status?.privateApiKey) ||
                    !status?.enabled ||
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Toggle the switch to enable automatic polling. The system will check for new form
                submissions every {pollingInterval} minutes
              </p>
            </div>
          </CardContent>
        </Card>
