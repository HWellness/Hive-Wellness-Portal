...
import { Eye, Search, Download, Filter, Calendar, Mail, User, FileText, Trash2, Archive, AlertTriangle } from 'lucide-react';
...
export default function FormSubmissionsDashboard() {
  ...
  const archiveSubmission = async (submissionId: string) => {
    try {
      const response = await apiRequest('PATCH', `/api/admin/form-submissions/${submissionId}/archive`);
      if (response.ok) {
        toast({
          title: "Success", 
  ...
  const filteredSubmissions = submissions.filter(submission => {
    const searchInFormData = submission.form_data && typeof submission.form_data === 'object' 
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Button onClick={() => setShowBulkDeleteDialog(true)} variant="outline" className="text-red-600 hover:text-red-700">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {submissions.filter(s => s.form_type === 'therapist_enquiry' || s.form_type === 'therapist_application').length}
                </p>
              </div>
            </div>
          </CardContent>
                            ...
                            <div className="space-y-4">
                              <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                  ...
                                  <div className="text-sm">
                                    <Badge className={getFormTypeColor(selectedSubmission.form_type)}>
                                      {selectedSubmission.form_type.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
                                    </Badge>
                                  </div>
                                </div>
                                <div>
                                ...
                                <div>
                                  ...
                                  <div className="text-sm">
                                    <Badge variant={selectedSubmission.processed ? "default" : "secondary"}>
                              ...
                              <div>
                                <label className="text-sm font-medium text-gray-600">Form Data</label>
      ...
      <Dialog open={!!showDeleteConfirm} onOpenChange={() => setShowDeleteConfirm(null)}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <p>Are you sure you want to delete this form submission? This action cannot be undone.</p>
      ...
      <Dialog open={showBulkDeleteDialog} onOpenChange={setShowBulkDeleteDialog}>
        <DialogContent>
          ...
          <div className="space-y-4">
            <p>Delete all form submissions for a specific email address. This action cannot be undone.</p>
