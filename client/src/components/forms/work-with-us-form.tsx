...
const specialisations = [
  "ADHD", "ASD", "Addiction", "Adoption", "Ageing", "Anger", "Anxiety", "Autism Spectrum Disorder",
  ...
  "Caregiving", "Gender Identity", "Health Anxiety", "Infertility", "Loneliness", "Loss",
  "Love Life", "Medical Trauma", "Menopause", "Money", "Mood Swings", "Negative Thoughts",
  "OCD", "PMS/PMDD", "Panic Attacks", "Parenting", "Past Life Events", "Personal Development",
  "Pet Loss", "Phobias", "Physical Disability", "Pregnancy", "Racism", "Relationship With Food",
  "Relationships", "Religion/Spirituality", "Self-Esteem/Confidence", "Self-Harm", "Divorce/Separation",
  "Sleeping Difficulties", "Smoking", "Stress/Burnout", "Sexuality", "Trauma", "Traumatic Childbirth",
  "Work", "World Events", "Other"
];

const personalityTraits = [
  "Warm", "Approachable", "Friendly", "Sociable", "Calm", "Grounding", "Reflective", "Thoughtful",
  "Optimistic", "Encouraging", "Practical", "Solution-focused", "Compassionate", "Empathetic",
  "Creative", "Open-minded", "Organised", "Structured", "Flexible", "Adaptable", "Confident",
  "Direct", "Gentle", "Reassuring", "Relaxed", "Informal", "Energetic", "Dynamic", "Motivational",
  "Empowering", "Challenging", "Supportive", "Quiet", "Observant", "Professional", "Boundaried"
];
...
export default function WorkWithUsForm({ onComplete }: WorkWithUsFormProps) {
  ...
  const getFieldsForStep = (step: number): (keyof WorkWithUsFormData)[] => {
    switch (step) {
      ...
      case 4: return ["hasLimitedCompany", "wantsSupportSettingUp"];
      case 5: return ["qualificationLevel"];
      case 6: return ["professionalBody"];
      case 7: return ["counsellingApproaches", "psychologicalTherapies", "specialistTherapies"];
      case 8: return ["therapeuticSpecializations"];
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 4:
        return (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold mb-4">Do you have a registered limited company?</h2>
            <div>
            ...
            {form.watch("hasLimitedCompany") === "no" && (
              <div>
                <Label className="text-sm font-medium mb-2 block">Would you like support setting this up? *</Label>
                <RadioGroup
                  value={form.watch("wantsSupportSettingUp")}
                  onValueChange={(value: "yes" | "no") => form.setValue("wantsSupportSettingUp", value)}
                >
                  <div className="flex items-center space-x-2">
      ...
      case 5:
        return (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold mb-4">What is your highest level of qualification in psychology or therapy?</h2>
            <div>
      ...
      case 6:
        return (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold mb-4">What professional body are you registered with?</h2>
      ...
      case 7:
        return (
          <div className="space-y-6">
            ...
            <p className="text-sm text-gray-600 mb-4">Which types of therapy do you provide? (Tick all that apply)</p>
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        if (checked) {
                          ...
                          form.setValue("counsellingApproaches", current.filter(a => a !== approach));
                        }
                      }}
                    />
                    <Label htmlFor={`counselling-${approach}`} className="text-sm">{approach}</Label>
                  </div>
                ))}
              </div>
            </div>
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        if (checked) {
                          ...
                          form.setValue("psychologicalTherapies", current.filter(t => t !== therapy));
                        }
                      }}
                    />
                    <Label htmlFor={`psychological-${therapy}`} className="text-sm">{therapy}</Label>
                  </div>
                ))}
              </div>
            </div>
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        if (checked) {
                          ...
                          form.setValue("specialistTherapies", current.filter(t => t !== therapy));
                        }
                      }}
                    />
                    <Label htmlFor={`specialist-${therapy}`} className="text-sm">{therapy}</Label>
                  </div>
                ))}
              </div>
            </div>
      ...
      case 8:
        return (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold mb-4">What areas do you specialise or have experience in?</h2>
                    ...
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        if (checked) {
                          ...
                          form.setValue("therapeuticSpecializations", current.filter(s => s !== spec));
                        }
                      }}
                    />
      ...
      case 9:
        return (
          <div className="space-y-4">
            <h2 className="text-xl font-semibold mb-4">How would you describe your personality as a therapist?</h2>
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      if (checked && current.length < 2) {
                        ...
                        form.setValue("personalityTraits", current.filter(t => t !== trait));
                      }
                    }}
                    disabled={!form.watch("personalityTraits")?.includes(trait) && (form.watch("personalityTraits")?.length || 0) >= 2}
                  />
