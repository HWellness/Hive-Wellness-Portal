...
const PublicTherapistQuestionnairePage = lazy(() => import("@/pages/public-therapist-questionnaire"));
...
const TherapistPasswordManagement = lazy(() => import("@/pages/admin/therapist-password-management"));
const ClientTherapistAssignment = lazy(() => import("@/components/admin/client-therapist-assignment").then(module => ({ default: module.ClientTherapistAssignment })));
const AssignmentNotifications = lazy(() => import("@/components/admin/assignment-notifications").then(module => ({ default: module.AssignmentNotifications })));
...
const VideoSessionsProductionPage = lazy(() => import("@/components/services/video-sessions-production"));
...
function Router() {
  ...
  if (process.env.NODE_ENV === 'development') {
    console.log('App Router: Auth state:', { isAuthenticated, isLoading, user: user ? { role: user.role, id: user.id } : null });
      ...
      <Suspense fallback={<LoadingSpinner />}>
        ...
        {!isAuthenticated ? (
          <>
            ...
            <Route path="/public-therapist-questionnaire" component={PublicTherapistQuestionnairePage} />
          ...
          <>
            ...
            <Route path="/therapist-dashboard">
              {() => <ProtectedRoute fallbackPath="/therapist-login"><Portal /></ProtectedRoute>}
            </Route>
            ...
            <Route path="/admin/therapist-password-management" component={TherapistPasswordManagement} />
            <Route path="/video-sessions">
              {() => <VideoSessionsProductionPage user={user as any} />}
            </Route>
            <Route path="/admin-services" component={AdminDashboard} />
            <Route path="/admin-services/client-therapist-assignment" component={ClientTherapistAssignment} />
            <Route path="/admin-services/client-assignment" component={ClientTherapistAssignment} />
            <Route path="/admin-services/assignment-notifications" component={AssignmentNotifications} />
            <Route path="/admin-services/therapist-status" component={TherapistStatusManager} />
            <Route path="/institution-dashboard">
              {() => <ProtectedRoute><InstitutionDashboard /></ProtectedRoute>}
            </Route>
