  ...
  try {
    ...
    const categories = [
      ...
      },
      {
        ...
        description:
          "Targeted support for adult mental health concerns like anxiety disorders, depression, or trauma. These therapies use advanced, evidence-based techniques to help shift thought patterns and behaviours.",
      ...
      },
      {
        ...
        description:
          "Specialist support for complex, longstanding, or severe psychological difficulties, drawing on advanced therapeutic approaches and expert clinical insight.",
