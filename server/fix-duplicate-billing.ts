    ...
    try {
      ...
      try {
        ...
        const refundRecord: InsertRefund = {
          ...
          processedBy: "system",
          notes:
            "Automatic refund for duplicate billing error - client was incorrectly charged twice for same appointment slot",
        };
      ...
      console.log(
        `✅ Client now has ${activeAppointments.length} active appointments:`,
